...
Substitutes and complements are important because "All else being equal, demand for a product increases when the price of its complement decreases." This simple rule reigns great power over many industries, especially tech. 
