...
I still haven't figured out how to add blockquotes, so you'll see some large quotes as bullet points for now. However, **I did add a table of contents** that hopefully improves the browsing experience. 
