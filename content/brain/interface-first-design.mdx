...
---
I first wrote about Interface First Design on [[October 20th, 2020]]. That was before I read [these notes](https://lethain.com/notes-philosophy-software-design/) on [[A Philosophy of Software Design]]
...
Developers, especially new developers, are quick to jump to the tactical phase. It __feels__ like the faster path to the end. In school, it often works because the api doesn't really matter, because you only use it a few times before you ditch it for the next assignment. However, for software you will continually improve upon and come back to, the strategic phase is just as important, if not more so. 
[[John Ousterhout]] supports this claim, writing "payoff for good design comes quickly. It's unlikely that the tactical approach
