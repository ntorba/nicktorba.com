...
- I wish I had picked this up much sooner in my programming journey. A clear goal gives you a much better idea of how to interact with libraries and new code you write. The extra 15 minutes spent designing pays off even if you don't follow through with the full project. It's time spent improving your design skill itself, while leaving behind a clear artifact of the original vision of this project.
- The alternative is to dive right into the first thing you can think of. Something like instantiating a beautiful soup object and figure out which html tags you need to grab. This is how I used to work on all projects. I'd think "why waste time when I don't even know if what I want to do is possible." If I could go back, I'd tell myself
